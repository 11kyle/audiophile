...
export default function Navbar() {
  ...
  return (
    <>
    <header className="relative bg-[#191919]">
      <nav aria-label="Top" className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative border-b border-white/10 px-4 pb-14 sm:static sm:px-0 sm:pb-0">
          <div className="flex h-24 items-center justify-between">
            ...
            <div className="absolute inset-x-0 bottom-0 overflow-x-auto border-t sm:static sm:border-t-0">
              <div className="flex h-14 items-center space-x-8 px-4 sm:h-auto">
                {navigation.map((item) => (
                  <a key={item.name} href={item.href} className="text-sm font-medium text-white hover:text-orange-500">
                    {item.name}
                  </a>
                ))}
              </div>
            ...
            <div className="flex flex-1 items-center justify-end">
              ...
              <Popover className="ml-4 flow-root text-sm lg:relative lg:ml-8">
                ...
                <Transition
                  ...
                  leaveTo="opacity-0"
                >
                  <Popover.Panel className="z-10 absolute inset-x-0 top-16 mt-px bg-white py-6 shadow-lg sm:px-2 lg:left-auto lg:right-0 lg:top-full lg:-mr-1.5 lg:mt-3 lg:w-80 lg:rounded-lg lg:ring-1 lg:ring-black lg:ring-opacity-5">
                    <h2 className="text-lg font-medium text-gray-900 px-4">Shopping Cart</h2>
                    ...
                    <form className="mx-auto max-w-2xl px-4">
                      ...
                      <button
                        type="submit"
                        className="w-full rounded-md border border-transparent bg-orange-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                      >
                        Checkout
                      </button>
                    </form>
