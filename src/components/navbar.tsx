...
export default function Navbar() {
  ...
  return (
    <>
      <Disclosure as="nav" className="bg-[#191919]">
        {({ open }) => (
          <>
            <div className="mx-auto max-w-[1110px] px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 lg:h-24 items-center justify-between border-b border-white/10">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  <button
                    ...
                    className="rounded-full bg-[#191919] p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                  >
